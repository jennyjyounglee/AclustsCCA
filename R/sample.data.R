...
#'
#'
#' @format A \code{list} of length 10, which are:
#' \describe{
#' \item{DATA.X}{A \eqn{n=1000} by \eqn{p} matrix where \eqn{n} is a number of subjects and \eqn{p} is a number of exposures.}
#' \item{DATA.Y}{A \eqn{n=1000} by \eqn{q} matrix where \eqn{n} is a number of subjects and \eqn{q} is a number of CpG sites.}
#' \item{DATA.Z}{A \eqn{n=1000} by 2 matrix where \eqn{n} is a number of subjects and 2 is a number of confounders.}
#' \item{clusters.list}{A list of 9 clusters with CpG sites obtained using A-clustering, each item is a cluster that contains a set of probes.}
#' \item{TRUE.Clusters}{A index of clusters that are truly associated with exposures}
#' \item{TRUE.Cancors}{A true canonical correlation for each true clusters}
#' \item{TRUE.CpGs}{A list of 28 true CpG sites that are associated with exposures}
